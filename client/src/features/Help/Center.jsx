...
const Center = () => {
  ...
  const faqlist = [
    ...
    {
      "question": "What should I do if I encounter issues on Opinion?",
      "answer": "If you encounter any issues while using Opinion, please contact our support team through the app or visit our website's support section for assistance."
    }
  ]
