...
const ProfileOptions = (props) => {
  ...
  const profileoptions = [
    { name: "My Activities", url: "/profile/my/activities", icon: <HistoryIcon />, state: false },
    { name: "Connections", url: "/profile/connections", icon: <PeopleIcon sx={{ fontSize: 28 }} />, state: false },
    { name: "Pages Joined", url: "/profile/pages/joined", icon: <ArticleIcon sx={{ fontSize: 28 }} />, state: false },
