                  ...
                  <div style={{ height: "65vh", overflowY: "auto",  }}>
                    ...
                    <div style={{ paddingLeft: 7, width: 470,  paddingTop:15 }}>
                      <TextField fullWidth
                        ...
                        InputLabelProps={{ shrink: true }} placeholder='Write something about yourself' label="Bio" multiline rows={4} defaultValue="" />
                    </div>
    ...
    return <div style={{ height: "80vh",  padding: 5, overflowY: "scroll", overflowX:'hidden' }}>
      <div>
        ...
        <div style={{ display: "flex", flexDirection: "column", padding: 10, }}>
          <div style={{padding:5}}>
            {wrapTextInputItem({ label: "First Name", size: "small", value: "course", })}
          </div>
          <div style={{padding:5}}>
            {wrapTextInputItem({ label: "Last Name", size: "small", value: "course", })}
          </div>
          <div style={{padding:5}}>
            {wrapTextInputItem({ label: "Location", size: "small", value: "course", })}
          </div>
        </div>
