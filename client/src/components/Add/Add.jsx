  ...
  const getDesktopView = () => {
    return <div style={{display:"flex", justifyContent:"center", }}>
              <div>
                    ...
                    <div style={{paddingLeft:5}}>
                      {
                        wrapMenuItem({
                          value: 'addnew',
                          minWidth: 140, label: "Add New",
                          menuItemList: ["POST", "PAGE",]
                        })
                      }
                    </div>
                    <div>
                      {
                        ...
                        <div style={{paddingTop:8}} >
                          {wrapTextInputItem({ label: "Post Title", size: "small", value: "post_title", width: 400, marginLeft: 5 })}
                        </div>
                        :<></>
                      }
                  ...
                  addnewinfo.addnew === "POST"?
                    <div style={{ height: "65vh", overflowY: "auto", padding: 5, }}>
                      ...
                      <div style={{padding:5, }}>
                      {
                        wrapMenuItem({
                          value: 'page',
                          minWidth: 200, label: "Page",
                          menuItemList: ["p/page1", "p/page2",]
                        })
                      }
                      </div>
                ...
                {
                  addnewinfo.addnew === "PAGE"?
                    <div style={{ height: "65vh", overflowY: "auto", paddingLeft:10 }}>
                      ...
                      <div style={{ display: "flex", padding: 5, paddingLeft: 4 }}>
                        {wrapTextInputItem({ label: "Page Name", size: "small", value: "page_name", width: 240, marginLeft: 5 })}
                      </div>
                      <div style={{ display: "flex", padding: 5, paddingLeft: 4 }}>
                        {wrapTextInputItem({ label: "Public Username", size: "small", value: "public_username", width: 240, marginLeft: 5 })}
                      </div>
                      <div style={{ display: "flex", padding: 5, paddingLeft: 4 }}>
                      ...
                      <div style={{ paddingLeft: 7, width: 470,  paddingTop:15 }}>
                        <TextField fullWidth
                          ...
                          InputLabelProps={{ shrink: true }} placeholder='Write short description about page' label="Bio" multiline rows={4} defaultValue="" />
                      </div>
                      ...
                      <div style={{ display: "flex", padding: 5 }}>
                        {wrapButtonView({ text: 'Create New Page', size: "medium" })}
                      </div>
                    </div> 
                    :<></>
                }  
        ...
        { addnewinfo.addnew === "POST"?
          <div style={{}}>
            <div style={{ display: "flex", flexDirection: "column", padding: 5, }}>
              {wrapTextInputItem({ label: "Post Title", size: "small", value: "post_title", width: 300, marginLeft: 5 })}
            </div>
            ...
            <div style={{ display:"flex" }}>
              ...
              <div style={{padding:5, }}>
                <div  style={{ paddingTop:10}}>
                  {wrapTextInputItem({ label: "Page Name", size: "small", value: "page_name", width: 160, marginLeft: 5 })}
                </div>
                <div style={{ paddingTop:7}}>
                  {wrapTextInputItem({ label: "Public Username", size: "small", value: "page_name", width: 160, marginLeft: 5 })}
                </div>
              </div>
            </div>
            <div style={{ paddingLeft: 7, border: "1px solid #fff",padding:10 }}>
              <TextField fullWidth
                ...
                InputLabelProps={{ shrink: true }} placeholder="Write short description about page" label="Bio" multiline rows={8} defaultValue="" />
            </div>
            <div style={{ padding: 5, color: "red", width: 250,  paddingLeft:10,  }}>
              {profileError && "Error : " + profileError.message || error1 && "Error : " + error1.message }
            </div>
